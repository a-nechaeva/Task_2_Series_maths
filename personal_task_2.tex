...
\begin{multline*}
 \left|\frac{\sin n}{n} + \frac{\cos n - 1}{n^2} \right| =  \left|\frac{2\cos\frac{n}{2}\sin \frac{n}{2}}{n} - \frac{\left(\sin\frac{n}{2} \right)^2}{n^2} \right| = \frac{\left|\sin\frac{n}{2} \right|}{n}  \left|2\cos\frac{n}{2} - \frac{\sin\frac{n}{2}}{n} \right| \geq\\
\geq 
\end{multline*}
...
\textbf{!!!В РАСХОДИМОСТИ РЯДОВ НУЖНО ДОКАЗАТЬ, ЧТО РАСХОДИТСЯ ИЗ СУММЫ ТОЛЬКО 1!!!}
