...
\lim_{n \to \infty} e^n\cdot e^{ \frac{n^2+3n}{-n-1}}  = \lim_{n \to \infty}  e^{\frac{-2n}{n+1}} = e^{-2} \neq 0 \\
\end{multline*}
Следовательно, ряд расходится.\\\\
\underline{Ответ:} ряд  \textbf{расходится}

\begin{figure}[h]
		\center{\includegraphics[width=1\linewidth]{"./кот_1.jpg"}}
...
\end{equation}
1. Нахождение области условной сходимости ряда\\
...
Рассмотрим поведение ряда в точках $x = \frac{\pi m}{2}, \, m \in N$. Сходимость ряда при четных значениях $m \in N$ доказана выше. В точках вида $x = \frac{\pi}{2} \cdot (2k + 1), \,\, k \in  Z_+$:
\begin{equation*}
\frac{\cos( n \pi \cdot (2k + 1)) }{2n^{\frac{x}{3}}}+\frac{ \cos (2 n \pi\cdot (2k + 1)) }{2n^{\frac{x}{3}}} = \frac{(-1)^n }{2n^{\frac{x}{3}}}+\frac{1 }{2n^{\frac{x}{3}}}
\end{equation*}
Ряд с общим членом $\frac{(-1)^n }{2n^{\frac{x}{3}}}$ сходится по признаку Лейбница при $x > 0$, а $\frac{1 }{2n^{\frac{x}{3}}}$ -- при $x > 3$, значит, их сумма сходится при $x > 3$. Ряд сходится при $x = \frac{\pi}{2} \cdot (2k + 1), \,\, k \in  N$ и расходится при $x = \frac{\pi}{2}$.\\\\

Область \textbf{условной} сходимости  $$x \in (0, + \infty) \backslash  \left\{  \frac{\pi}{2}\right\}$$
...
\underline{Ответ:} при $x \in (0, + \infty) \backslash  \left\{  \frac{\pi}{2}\right\} $  ряд сходится \textbf{условно}, при $x \in (3, + \infty) $  -- \textbf{абсолютно}.
...
\begin{figure}[h]
		\center{\includegraphics[width=0.85\linewidth]{"./кот_2.jpg"}}
                    %  \includegraphics{"./Q-table.jpg"}
...
\begin{figure}[h]
		\center{\includegraphics[width=1\linewidth]{"./кот_3.jpg"}}
                    %  \includegraphics{"./Q-table.jpg"}
